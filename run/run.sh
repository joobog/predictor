...
#../build/predictor --alg=svm --svm-trainer=ova  --csv-input-file=/home/joobog/git/trace_analyse/data/irisdb.csv

#../build/predictor --alg=svm --svm-trainer=ova adm --separate-files false --csv-input-file=/home/joobog/git/trace_analyse/data/irisdb.csv
